...
const Svg: FC<ISvgProps> = ({ color }) => (
  ...
  >
    <defs>
      ...
      >
        <stop stopColor={color} offset=".3" />
        <stop stopColor={color} offset=".5" />
        <stop stopColor={color} offset=".8" />
      </linearGradient>
      <clipPath id="j">
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor={color} offset=".57" />
        <stop stopColor={color} offset=".72" />
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor={color} offset=".16" />
        <stop stopColor={color} offset=".38" />
        <stop stopColor={color} offset=".47" />
        <stop stopColor={color} offset=".7" />
        <stop stopColor={color} offset=".9" />
      </linearGradient>
    </defs>
    <path
