...
const Svg: FC<ISvgProps> = ({ colors: { accent, font } }) => (
  ...
  >
    <defs>
      ...
      >
        <stop stopColor={accent} offset=".3" />
        <stop stopColor={accent} offset=".5" />
        <stop stopColor={accent} offset=".8" />
      </linearGradient>
      <clipPath id="j">
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor={accent} offset=".57" />
        <stop stopColor={accent} offset=".72" />
        <stop stopColor={accent} offset="1" />
      </linearGradient>
      <clipPath id="h">
