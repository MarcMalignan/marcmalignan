  ...
  return (
    <Section title={t('nav.skills')}>
      <Paragraph>
        ...
        sollicitudin vel ante sit amet viverra. Aenean sed est vitae odio
        lobortis posuere. Fusce ut dignissim velit. Etiam et mattis arcu.
        Maecenas faucibus eros pretium ipsum ullamcorper viverra. Suspendisse
        consectetur turpis in massa varius, in hendrerit leo gravida. Nulla
        facilisi.
      </Paragraph>
      <Paragraph>
        ...
        Fusce faucibus, libero sit amet gravida varius, justo odio luctus
        mauris, sed mattis mauris dolor ut purus. Pellentesque at arcu
        vulputate, pretium ante luctus, eleifend nunc. Mauris lacinia nunc
        dolor, a eleifend odio molestie fermentum.
      </Paragraph>
    </Section>
  );
};
